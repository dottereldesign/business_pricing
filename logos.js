...
const newFavouriteLogos = [100, 101, 102, 103, 96, 97, 98, 99, 92, 93, 94, 95, 88, 89, 90, 91, 84, 85, 86, 87, 80, 81, 82, 83, 76, 77, 78, 79, 72, 73, 74, 75, 68, 69, 70, 71, 60, 61, 62, 63, 64, 65, 66, 67].flatMap((sheet) =>
...
if (logoGallery) {
  ...
  logoCount.textContent = `${items.length} images / 900 individual marks + 7 intact boards`;
}
